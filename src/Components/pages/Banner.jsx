  ...
  return (
    <div className="  w-11/12  h-full mx-auto flex flex-col sm:flex-row items-center justify-between overflow-hidden mb-30 mt-9 sm:mt-15  pb-5 md:pb-0">
      <div className="space-y-5  pb-5">
        ...
        <div className=" gap-5">
          <Link to='/allBooks' className="btn w-[150px] sm:w-[200px] hover:opacity-90 mr-2 rounded-4xl  border-0 text-white bg-indigo-600">All Books</Link>
          <Link to='/addBook' className="btn  rounded-4xl  w-[150px] sm:w-[200px] border-0 text-white bg-indigo-600 hover:opacity-90">Create Book</Link>
        </div>
      </div>
      <div className="">
        <motion.img
